...
Feature: Flujo Transferencia a otros bancos
  ...
  Scenario Outline: Usuario transfiere a otros bancos con cuenta registra e importe pignorado
    ...
    When Llama al endpoint realizar transacción a otros bancos
      | pStrNombreUsuario   | pIntJtsOidOrigen   | pIntLstOtrosBancos   | pBlnControlUIF   | pDblImporte   | pIntMoneda   | pStrDescripcionTrans   | pStrCanal   |
      | <pStrNombreUsuario> | <pIntJtsOidOrigen> | <pIntLstOtrosBancos> | <pBlnControlUIF> | <pDblImporte> | <pIntMoneda> | <pStrDescripcionTrans> | <pStrCanal> |
   ...
   |3127471   |82db39b08d109ee1   |Android SDK built for x86   |ANDROID   |1234   |1   |59806c2249cef7a3   |59806c2249cef7a3   |v2.4.52   |59806c2249cef7a3   |59806c2249cef7a3   |2075780   |4447404   |false   |5   |0   |Transacción Automatizada|
